#
#  Be sure to run `pod spec lint SVProgressHUDLib.podspec' to ensure this is a
...
12345567890
  ...
  s.homepage     = "https://github.com/appledev201888/SVProgressHUDLib"
  ...
  s.source       = { :git => "https://github.com/appledev201888/SVProgressHUDLib.git", :tag => "#{s.version}" }
